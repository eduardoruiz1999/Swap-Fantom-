...
import { UniswapV3Swap } from "@/components/uniswap-v3-swap"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-md relative z-10">
        ...
        {/* Swap Interface with Tabs */}
        <Tabs defaultValue="v2" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-black/60 border border-gray-600/50">
            <TabsTrigger value="v2" className="text-white data-[state=active]:bg-white/20">
              V2 Swap
            </TabsTrigger>
            <TabsTrigger value="v3" className="text-white data-[state=active]:bg-white/20">
              V3 Swap
            </TabsTrigger>
          </TabsList>

          <TabsContent value="v2" className="mt-4">
            {/* Original V2 Swap Card */}
              ...
              <div className="relative z-10">
                <CardHeader className="pb-4">
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-white">Swap Tokens (V2)</CardTitle>
